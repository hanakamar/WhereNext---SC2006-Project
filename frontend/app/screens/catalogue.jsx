...
const restaurantData = [
    { id: "1", name: "Jin Yu Man Tang Dessert", address: "08 East Coast Road", image: "https://plus.unsplash.com/premium_photo-1673108852141-e8c3c22a4a22?q=80&w=3540&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D", description: "Famous for its traditional Chinese desserts.", distance: 1.2, popularity: 4.5, price: 2 },
    { id: "2", name: "Chin Sin Huan", address: "265 Jalan Besar", image: "https://plus.unsplash.com/premium_photo-1673108852141-e8c3c22a4a22?q=80&w=3540&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D", description: "A historic eatery serving authentic Singaporean cuisine.", distance: 3.5, popularity: 4.2, price: 1 },
    { id: "3", name: "Dough", address: "30 Victoria Street", image: "https://plus.unsplash.com/premium_photo-1673108852141-e8c3c22a4a22?q=80&w=3540&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D", description: "A trendy café specializing in fresh pastries and coffee.", distance: 2.1, popularity: 4.7, price: 3 },
    { id: "4", name: "Fish Village @Maxwell", address: "Maxwell Hawker Centre", image: "https://plus.unsplash.com/premium_photo-1673108852141-e8c3c22a4a22?q=80&w=3540&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D", description: "Best seafood dishes in town!", distance: 0.8, popularity: 4.9, price: 1 },
    { id: "5", name: "Nakey", address: "10 Teranganu Street", image: "https://plus.unsplash.com/premium_photo-1673108852141-e8c3c22a4a22?q=80&w=3540&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D", description: "A healthy smoothie bowl shop with vegan options.", distance: 4.2, popularity: 4.0, price: 2 },
    { id: "6", name: "Nesuto", address: "78 Airport Boulevard", image: "https://plus.unsplash.com/premium_photo-1673108852141-e8c3c22a4a22?q=80&w=3540&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D", description: "Exquisite Japanese-style cakes and desserts.", distance: 5.0, popularity: 4.3, price: 3 },
];
      ...
      <FlatList
        ...
        renderItem={({ item }) => (
          ...
          >
            ...
            {selectedCategory === 'food' && <Text style={styles.info}>📍 {item.address}</Text>}
